...
f = open('A1/Data/quantum/CA-GrQc.txt', 'r')
linecount = 0
user = None
nomin = None
for line in f:
...
# Save the values
np.savez('A1/output/quantum/degreeCentrality', in_DegCor,out_DegCor,normIn_DegCor,normOut_DegCor)

print "Calculating Closeness Centrality"
# Closeness Centrality
closenessCentrality = nx.closeness_centrality(g)
np.savez('A1/output/quantum/closenessCentrality', closenessCentrality)

print "Calculating Betweenness Centrality"

# Betweenness Centrality
betweennessCentrality= nx.betweenness_centrality(g)
np.savez('A1/output/quantum/betweennessCentrality', betweennessCentrality)


print "Calculating Harmonic Centrality"
# Harmonic Centrality
harmonicCentrality = nx.harmonic_centrality(g)
np.savez('A1/output/quantum/harmonicCentrality', harmonicCentrality)
...
np.savez('A1/output/quantum/eccentricity', inEccentricity, outEccentricity)
...
np.savez('A1/output/quantum/clusteringCofficient', clusteringCofficient,clusteringCofficientWithReciprocal)

# PageRank Centrality
print "Calculating PageRank Centrality"
pageRank = nx.pagerank(g,alpha=0.85,personalization=None,weight='weight', dangling=None)
np.savez('A1/output/quantum/pageRank', pageRank)
...
np.savez('A1/output/quantum/eigenVector', eigenVector)
